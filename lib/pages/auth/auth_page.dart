    ...
    return Positioned(
      ...
      child: Padding(
        ...
        child: FloatingActionButton(
          ...
          onPressed:
          state is LoadingAuthState ? null :
              (){
            ...
            if (_phoneController.text.isNotEmpty && state is AuthInitialState && _pageIndex == 0) {
              BlocProvider.of<AuthBloc>(context)
                  .add(PhoneNumberVerificationEvent('+92${_phoneController.text}'));
              ...
              BlocProvider.of<AuthBloc>(context).add(PhoneAuthCodeVerifiedEvent(
                  _otpController.text, state.verificationId, '+92${_phoneController.text}'));
              setState(() {
                _pageIndex = 2;
              });
